 ...
 */
public class ScribbleEditorProvider extends AbstractTextEditorProvider {

    private final ScribbleEditorConfigurationFactory editorConfigurationFactory;
     ...
     */
    @Inject
    public ScribbleEditorProvider(final ScribbleEditorConfigurationFactory editorConfigurationFactory) {
