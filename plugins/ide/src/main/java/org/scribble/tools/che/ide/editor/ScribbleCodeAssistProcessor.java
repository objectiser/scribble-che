 ...
 */
public class ScribbleCodeAssistProcessor implements CodeAssistProcessor {

    private final ScribbleCodeAssistClient  client;
     ...
     */
    @Inject
    public ScribbleCodeAssistProcessor(final ScribbleCodeAssistClient client) {
        this.client = client;
