...
public interface ScribbleCodeAssistProcessorFactory {

    /**
     * Create a {@link ScribbleCodeAssistProcessor}.
     *
     * @param editor
     *         the editor
     * @return the JSON Example specific code assist processor
     */
    ScribbleCodeAssistProcessor create(EditorPartPresenter editor);
}
